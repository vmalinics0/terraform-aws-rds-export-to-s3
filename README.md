...
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Enable/disable module. Please note, if 'create_customer_kms_key' is true, then it will also disable/remove KMS Key if module is disabled. | `bool` | `true` | no |
